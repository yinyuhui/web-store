        ...
        <div class="container">
            <div class="cart">
                ...
                <div class="item-list-wrap">
                    ...
                    <el-table :data="userList" stripe border style="width: 100%" center>
                        ...
                        <el-table-column prop="userPwd" label="用户密码"  align="center">
                        </el-table-column>

                        <el-table-column prop="userList.roleType" label="用户角色" align="center">
                            <template slot-scope="scope">
                                <span v-if="scope.row.roleType === 'user'">消费者</span>
                        ...
                        <el-table-column label="操作" align="center">
                            <template slot-scope="scope">
                                <el-button type="danger" icon="el-icon-delete" size="mini" @click="deleteOrder(scope.row.userId) "></el-button>
                            <el-button type="primary" icon="el-icon-edit" size="mini" @click="goOrderDetail(scope.row.userId) "></el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
	...
	methods: {
		...
		init() {
			axios.get('/users/userList').then(res => {
				this.userList = res.data.result.reverse()
