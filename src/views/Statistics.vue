...
<template>
	<div>
		...
		<nav-menu :activeIndex="'5'"></nav-menu>
		...
		<div class="container">
			<div class="cart">
				...
				<div class="item-list-wrap">
					...
					<el-table :data="formData" stripe border style="width: 100%">
						...
						<el-table-column prop="hasOrderNum" label="下单笔数" width="160"  align="center">
						</el-table-column>
	...
	methods: {
		...
		init() {
			axios.get('/goods/productList').then(res => {
				this.productList = res.data.result.reverse()
				this.productList.forEach(item => {
					if (!isNaN(item.hasOrderNum)) {
